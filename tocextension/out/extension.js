...
const tocExplorer_textDocumentContentProvider_1 = require("./tocExplorer.textDocumentContentProvider");
...
function activate(context) {
    ...
    new tocExplorer_textDocumentContentProvider_1.TocExplorer(context);
